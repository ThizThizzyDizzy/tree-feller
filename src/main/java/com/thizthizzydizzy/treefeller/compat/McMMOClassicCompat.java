...
public class McMMOClassicCompat extends InternalCompatibility {
    ...
    private final HashMap<Material, Integer> exp = new HashMap<>();
    ...
    public void reload() {
        ...
        try {
            ...
            ConfigurationSection woodExp = YamlConfiguration.loadConfiguration(file).getConfigurationSection(
                    "Experience").getConfigurationSection("Woodcutting");
