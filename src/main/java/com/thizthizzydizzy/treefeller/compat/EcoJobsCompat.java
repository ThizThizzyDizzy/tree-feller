...
public class EcoJobsCompat extends InternalCompatibility {
    public static Option<HashMap<String, Double>> ECOJOBS_TRUNK_XP = new Option<HashMap<String, Double>>("EcoJobs " +
            "Trunk XP", true, true, true, null) {
        @Override
    ...
    public static Option<HashMap<String, Double>> ECOJOBS_LEAF_XP = new Option<HashMap<String, Double>>("EcoJobs Leaf" +
            " XP", true, true, true, null) {
        @Override
        public HashMap<String, Double> load(Object o) {
            if (o instanceof MemorySection) {
                HashMap<String, Double> jobs = new HashMap<>();
    ...
    public static OptionBoolean ECOJOBS_APPLY_MULTIPLIERS = new OptionBoolean("EcoJobs Apply Multipliers", true, true
            , true, true) {
        @Override
        public String getDesc(boolean ingame) {
