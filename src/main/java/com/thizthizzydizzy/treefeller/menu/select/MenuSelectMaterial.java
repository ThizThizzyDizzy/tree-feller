...
public class MenuSelectMaterial extends Menu {
    ...
    public MenuSelectMaterial(Menu parent, Plugin plugin, Player player, String name, boolean allowNull,
                              String filterName, Material defaultValue, Function<Material, Boolean> filter,
                              BiConsumer<MenuSelectMaterial, Material> setFunc) {
    ...
    public void refresh() {
        components.clear();
        ItemBuilder builder =
                makeItem(value == null ? Material.BLACK_CONCRETE : value).addLore("Click any " + filterName + " in " +
                        "your inventory to set the material.");
