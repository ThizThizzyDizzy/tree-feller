...
public class MenuModifyStringSet extends Menu {
    ...
    public MenuModifyStringSet(Menu parent, Plugin plugin, Player player, String name, boolean allowNull,
                               HashSet<String> defaultValue, Consumer<HashSet<String>> setFunc) {
