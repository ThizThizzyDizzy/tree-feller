...
public class MenuModifyMaterialSet extends Menu {//TODO make this multi-page allowing more to be visible
    ...
    public MenuModifyMaterialSet(Menu parent, Plugin plugin, Player player, String name, boolean allowNull,
                                 String filterName, HashSet<Material> defaultValue,
                                 Function<Material, Boolean> filter, Consumer<HashSet<Material>> setFunc) {
