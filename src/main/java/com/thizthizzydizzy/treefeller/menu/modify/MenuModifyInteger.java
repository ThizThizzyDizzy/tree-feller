...
public class MenuModifyInteger extends Menu {
    ...
    public MenuModifyInteger(Menu parent, Plugin plugin, Player player, String name, int min, int max,
                             boolean allowNull, Integer defaultValue, Consumer<Integer> setFunc) {
