...
public class MenuModifyShort extends Menu {
    ...
    public MenuModifyShort(Menu parent, Plugin plugin, Player player, String name, short min, short max,
                           boolean allowNull, Short defaultValue, Consumer<Short> setFunc) {
