...
public class MenuModifyStringList extends Menu {
    ...
    public MenuModifyStringList(Menu parent, Plugin plugin, Player player, String name, boolean allowNull,
                                ArrayList<String> defaultValue, Consumer<ArrayList<String>> setFunc) {
