...
public class MenuTreeConfiguration extends Menu{
    ...
    private void refresh(){
        ...
        for(int i = 0; i<Math.min(pageMax,Option.options.size()-offset); i++){
            ...
            add(new Button(index, o.getConfigurationDisplayItem().setDisplayName(o.getFriendlyName()).addLore(ChatColor.GRAY+shorten(Objects.toString(o.getValue(tree)), 42)).addLore(shorten(o.getDescription(), 42)), (click) -> {
